...
module bufrlib
  ...
  use bufr_types
      ...
      integer(bufr_int), intent(in), value :: nfile
  ...
  use bufr_types
    ...
    !>
    !> @author J. Ator @date 2005-11-29
    integer(bufr_int) function crdbufr_c( nfile, bufr, mxwrd ) bind(C, name='crdbufr')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(out) :: bufr(*)
      integer(bufr_int), intent(in), value :: nfile, mxwrd
  ...
  use bufr_types
      ...
      integer(bufr_int), intent(in), value :: nfile, nwrd
    ...
    !>
    integer(bufr_int) function icvidx_c( ii, jj, numjj ) bind(C, name='icvidx')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in), value :: ii, jj, numjj
  ...
  use bufr_types
    ...
    subroutine cpmstabs_c( nmtb, ibfxyn, cbscl, cbsref, cbbw, cbunit, cbmnem, cbelem, &
      ...
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in) :: ibfxyn(*), idfxyn(*), ndelem(*), idefxy(*)
      integer(bufr_int), intent(in), value :: nmtb, nmtd, maxcd
  ...
  use bufr_types
    ...
    subroutine strtbfe_c(ifxyn,ival,meaning,lmeaning,idfxy,idval) bind(C, name='strtbfe')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in), value :: ifxyn, ival, lmeaning, idfxy, idval
  ...
  use bufr_types
    ...
    subroutine srchtbf_c(ifxyi,ivali,ifxyd,mxfxyd,ivald,meaning,mxmng,lnmng,iret) bind(C, name='srchtbf')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in), value :: ifxyi, ivali, mxfxyd, ivald, mxmng
      integer(bufr_int), intent(inout) :: ifxyd
      integer(bufr_int), intent(out) :: lnmng, iret
    ...
    subroutine restd_c(lun, tddesc, nctddesc, ctddesc) bind(C, name='restd')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in), value :: lun, tddesc
      integer(bufr_int), intent(out) :: nctddesc, ctddesc(*)
    ...
    subroutine stseq_c(lun,irepct,idn,nemo,cseq,cdesc,ncdesc) bind(C, name='stseq')
      use iso_c_binding
  use bufr_types
      integer(bufr_int), intent(in), value :: lun, idn, ncdesc
      character(kind=c_char), intent(in) :: nemo(*), cseq(*)
      integer(bufr_int), intent(inout) :: irepct
      integer(bufr_int), intent(out) :: cdesc(*)
