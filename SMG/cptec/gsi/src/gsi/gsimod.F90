...
!EPV
     jcap_gfs,nlat_gfs,nlon_gfs,jcap_cut,center_name,wrf_mass_hybridcord,use_gfs_ncio,write_fv3_incr,&
!EPV
...
!
!EPV
!     center_name - First Guess Center name 
!EPV
...
!EPV
  namelist/setup/center_name,gencode,factqmin,factqmax,superfact,limitqobs,clip_supersaturation, &
!EPV
       factql,factqi,factqr,factqs,factqg, &     
