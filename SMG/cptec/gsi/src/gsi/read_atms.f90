...
! Set array index for surface-sensing channels
  ...
  if(jsatid == 'npp') then
     write(6,*) 'READ_ATMS: Recognized value jsatid kidsat=224 for jsatid '//jsatid
     kidsat=224
  elseif (jsatid == 'n20') then
     write(6,*) 'READ_ATMS: Recognized value jsatid kidsat=225 for jsatid '//jsatid  
     kidsat = 225
  elseif (jsatid == 'n21') then
     write(6,*) 'READ_ATMS: Recognized value jsatid kidsat=226 for jsatid '//jsatid  
     kidsat = 226
  else 
