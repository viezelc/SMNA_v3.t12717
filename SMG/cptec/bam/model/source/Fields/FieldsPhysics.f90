...
!  PRIVATE
  INTEGER, PARAMETER :: km   =19                       !ocean model vertical layers
...
!tar end
  ...
  INTEGER(KIND=i8), PUBLIC, ALLOCATABLE, DIMENSION(:,:) :: SoilMask ! Soil mask
  ...
  INTEGER, PUBLIC ,ALLOCATABLE          :: laymld(:,:)
  REAL(KIND=r8), PUBLIC ,ALLOCATABLE    :: hbath(:,:)
  REAL(KIND=r8), PUBLIC ,ALLOCATABLE    :: tdeep(:,:,:)
  REAL(KIND=r8), PUBLIC ,ALLOCATABLE    :: sdeep(:,:,:)
...
! fim add
    ...
    co2mix =0.0_r8
    ALLOCATE(laymld      (ibMax,jbMax))
    laymld =0
    ALLOCATE( hbath     (ibMax,jbMax))
    hbath =0.0_r8
    ALLOCATE( tdeep     (ibMax,km,jbMax))
    tdeep =0.0_r8
    ALLOCATE( sdeep     (ibMax,km,jbMax))
    sdeep =0.0_r8
