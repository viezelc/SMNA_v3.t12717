...
MODULE Constants
  ...
  REAL (KIND=r8), PARAMETER   :: tref  =                   300.0_r8! 300 K Temperature Reference Value (for linearizations)
  REAL (KIND=r8), PARAMETER   :: tbar  =                   300.0_r8! 300 K
  REAL (KIND=r8), PARAMETER   :: psref  =                 85000.0_r8! Pa Surface Pressure Reference Value  (for linearizations)
  ...
  REAL (KIND=r8), PARAMETER   :: cpv   =                  1846.0_r8! specific heat of water vapor at constant pressure          (j/kg/k)
  ...
  REAL (KIND=r8), PARAMETER   :: p000   =                101325.e0_r8! Pressao de referencia ao nivel do mar (Pa)
  ...
  REAL (KIND=r8), PARAMETER   :: QPSM1  =    con_rv/con_rd-1.0_r8 ! #
  ...
  REAL(KIND=r8), PARAMETER :: MinFlux =-800.0_r8
  REAL(KIND=r8), PARAMETER :: MaxFlux = 800.0_r8
