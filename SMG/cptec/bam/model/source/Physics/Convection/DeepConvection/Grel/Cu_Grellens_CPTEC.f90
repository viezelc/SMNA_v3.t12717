...
SAVE
  ...
  PRIVATE
  PUBLIC :: Run_GrellEns_CPTEC,Init_GrellEns_CPTEC
...
CONTAINS
  SUBROUTINE Init_GrellEns_CPTEC()
    !
  ...
  END SUBROUTINE Init_GrellEns_CPTEC

  SUBROUTINE Run_GrellEns_CPTEC(&
...
!    ter11(1:nCols) = zz(1:nCols)
    ...
    RETURN
  END SUBROUTINE Run_GrellEns_CPTEC
