...
!----------------------------------------------------------------------------
      subroutine setcoef_sw( &         !      setcoef_sw( &
                            nlayers,  &!                   nlay                   , &
...
! ----- Output -----
      ...
      real(kind=r8), intent(out) :: colo2(1:nlayers)         ! column amount (o2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colmol(1:nlayers)         ! 
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: co2mult(1:nlayers)       !
                                                        !    Dimensions: (nlayers)
