...
!----------------------------------------------------------------------------
      subroutine setcoef( &             !       call setcoef( &
                         nlayers     , &!                nlay                               , &
                         istart      , &!                istart                             , &
                         pavel       , &!                pavel       (1:nlayers)            , &
                         tavel       , &!                tavel       (1:nlayers)            , &
                         tz          , &!                tz          (0:nlayers)            , &
                         tbound      , &!                tbound                             , &
                         semiss      , &!                semiss      (1:nbndlw)             , &
                         coldry      , &!                coldry      (1:nlayers)            , &
                         wkl         , &!                wkl         (1:mxmol,1:nlayers)    , &
                         wbroad      , &!                wbrodl      (1:nlayers)            , &
                         laytrop     , &!                laytrop                            , &
                         jp          , &!                jp          (1:nlayers)            , &
                         jt          , &!                jt          (1:nlayers)            , &
                         jt1         , &!                jt1         (1:nlayers)            , &
...
! ----- Input -----
      ...
      real(kind=r8), intent(in) :: pavel(1:nlayers)           ! layer pressures (mb) 
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: tavel (1:nlayers)               ! layer temperatures (K)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: tz(0:nlayers)              ! level (interface) temperatures (K)
      ...
      real(kind=r8), intent(in) :: coldry(1:nlayers)          ! dry air column density (mol/cm2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: wbroad(1:nlayers)          ! broadening gas column density (mol/cm2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: wkl(1:mxmol,1:nlayers)            ! molecular amounts (mol/cm-2)
...
! ----- Output -----
      ...
      integer, intent(out) :: jp(1:nlayers)          ! 
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: jt(1:nlayers)          !
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: jt1(1:nlayers)         !
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: planklay(1:nlayers,1:nbndlw)     ! 
                                                        !    Dimensions: (nlayers,nbndlw)
      real(kind=r8), intent(out) :: planklev(0:nlayers,1:nbndlw)    ! 
                                                        !    Dimensions: (0:nlayers,nbndlw)
      real(kind=r8), intent(out) :: plankbnd(1:nbndlw)       ! 
                                                        !    Dimensions: (nbndlw)

      real(kind=r8), intent(out) :: colh2o(1:nlayers)         ! column amount (h2o)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colco2(1:nlayers)         ! column amount (co2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colo3(1:nlayers)          ! column amount (o3)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: coln2o(1:nlayers)         ! column amount (n2o)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colco(1:nlayers)          ! column amount (co)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colch4(1:nlayers)         ! column amount (ch4)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colo2(1:nlayers)          ! column amount (o2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colbrd(1:nlayers)         ! column amount (broadening gases)
                                                        !    Dimensions: (nlayers)

      integer, intent(out) :: indself(1:nlayers)
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: indfor(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: selffac(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: selffrac(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: forfac(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: forfrac(1:nlayers)
                                                        !    Dimensions: (nlayers)

      integer, intent(out) :: indminor(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: minorfrac(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: scaleminor(1:nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: scaleminorn2(1:nlayers)
                                                        !    Dimensions: (nlayers)
