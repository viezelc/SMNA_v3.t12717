...
cat <<EOT0 > ${direxe}/${varname}.nml
 &InputDim
  Idim=360, ! Idim=360,         ! Number of Longitudes at the NCEP SST Weekly Grid
  Jdim=180,  ! Jdim=180,         ! Number of Latitudes at the NCEP SST Weekly Grid
...
rec=`${dirgrads}/wgrib2 -s -YY -d 1 -order we:ns gdas1.T${hh}Z.sstgrb2.${YYYYMMDD}${hh} -ieee gdas1.T${hh}Z.sstgrd.${YYYYMMDD}${hh}`
