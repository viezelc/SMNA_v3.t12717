...
cat <<EOT0 > ${direxe}/${varname}.nml
 &ChopNML
  ...
  Iter=100,            ! Number of Iteractions in Topography Smoothing
  ...
  DataGDAS="Spec",    ! DataGDAS="Grid" [gblav.ThhZ.atmanl.nemsio.yyyymmdddd]  or DataGDAS="Spec" [gdas1.ThhZ.SAnl.yyyymmddhh]
...
#PBS -l nodes=${cpu_node}:ppn=${cpu_mpi}
#PBS -A ${QUOTA}
#PBS -V
#PBS -S /bin/bash
#PBS -N $RES
