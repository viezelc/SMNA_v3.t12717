        ...
        IF(Km2 == Km1)THEN
           ...
           IF(p2(i,k) <= p1(i,1) .and. p2(i,k) >= p1(i,Km1)  )THEN
              IF(k > 1.and.k < Km2)THEN
                 ...
                 u2(i,k)  =0.25_r8*c2(i,k-1,1)+0.5_r8*c2(i,k,1)+0.25_r8*c2(i,k+1,1)!c2(i,k,1)
                 v2(i,k)  =0.25_r8*c2(i,k-1,2)+0.5_r8*c2(i,k,2)+0.25_r8*c2(i,k+1,2)!c2(i,k,2)
              ELSE IF(k == 1 )THEN
                 t2(i,k)  =t1(i,1)
                 q2(i,k,1)=q1(i,1,1)
                 u2(i,k)  =u1(i,1)
                 v2(i,k)  =v1(i,1)
              ELSE IF(k == km2 )THEN
                 t2(i,k)  =0.25_r8*t2(i,k-2  )+0.5_r8*t2(i,k-1  )+0.25_r8*c2(i,k,3)	    !t1(i,k) 
                 q2(i,k,1)=0.25_r8*q2(i,k-2,1)+0.5_r8*q2(i,k-1,1)+0.25_r8*c2(i,k,4)	    !q1(i,k,1)
                 u2(i,k)  =0.25_r8*u2(i,k-2  )+0.5_r8*u2(i,k-1  )+0.25_r8*c2(i,k,1)!c2(i,k,1) !u1(i,k)
                 v2(i,k)  =0.25_r8*v2(i,k-2  )+0.5_r8*v2(i,k-1  )+0.25_r8*c2(i,k,2)!c2(i,k,2) !v1(i,k)
              END IF
        ...
        IF(Km2 == Km1)THEN
           ...
           IF(p2(i,k) <= p1(i,1) .and. p2(i,k) >= p1(i,Km1)  )THEN
              ...
              ELSE IF(k == 1 )THEN
                 q2(i,k,n)=q1(i,1,n)
              ELSE IF(k == km2 )THEN
                 q2(i,k,n)=0.25_r8*q2(i,k-2,n)+0.5_r8*q2(i,k-1,n)+0.25_r8*c2(i,k,3+n)	    !q1(i,k,1)
              END IF
          ELSE !IF(p2(i,k) > p1(i,1) .and. p2(i,k) <= p1(i,Km1)  )THEN
              IF(k == 1 )THEN
                 q2(i,k,n)=q1(i,1,n)
	  ...
	  END IF
        ...
        ELSE
           ...
           ELSE IF(k==km2 .and. km2 < km1)THEN
              q2(i,k,n)=c2(i,k,3+n)
           ELSE
              q2(i,k,n)=q1(i,1,n)*EXP(dlpvdrt*(1.0_r8/t2(i,k)-1.0_r8/t1(i,1))-dz)
           END IF
        END IF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!  INTEGER, DIMENSION (Ibdim,Km2) :: k1s
  ...
  k1s=0
  q2 =0.0_r8; z1a=0.0_r8; z1b=0.0_r8; z1c=0.0_r8; z1d=0.0_r8; 
  z2s=0.0_r8; q1a=0.0_r8; q1b=0.0_r8; q1c=0.0_r8; q1d=0.0_r8;
  q2s=0.0_r8; ffa=0.0_r8; ffb=0.0_r8; ffc=0.0_r8; ffd=0.0_r8;
    ...
    DO n=1,Nm
      DO i=1,Im
        ...
        ELSE IF (k2 == km2 .and. km2 < Km1-1 .and. k1 < Km1-1) THEN
          ...
          q1c=q1(i,k1+1,n)
          q1d=q1(i,k1+2,n)
          q2s=0.50_r8*q1(i,k1-2,n) + 0.25_r8*q1(i,k1-1,n) + 0.25_r8*q1(i,k1,n)
