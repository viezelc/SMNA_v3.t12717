...
MODULE InputParameters
   ...
   CHARACTER (LEN=8), PUBLIC :: VarName='SSTClima'
   ...
   CHARACTER (LEN=12) :: NameNML='SSTClima.nml'
   ...
   INTEGER, PUBLIC :: nfclm=30   ! To Read Formatted Climatological SST
   INTEGER, PUBLIC :: nfsto=40   ! To Write Unformatted Gaussian Grid SST
   INTEGER, PUBLIC :: nfout=50   ! To Write GrADS Topography, Land Sea, Se Ice and Gauss SST
