...
MODULE InputParameters
   ...
   CHARACTER (LEN=255), PUBLIC :: VarName='SSTDailyDirec'
   ...
   CHARACTER (LEN=255), PUBLIC :: DirObsSST='pre/datasst/oiv2daily' ! Observed SST Datain Directory

   CHARACTER (LEN=11), PUBLIC :: FileClmSST='sstaoi.form'

   CHARACTER (LEN=23) :: NameNML='SSTDailyDirec.nml'
