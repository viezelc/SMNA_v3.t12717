...
MODULE InputParameters
   ...
   CHARACTER (LEN=12),PUBLIC :: VarNameV='TopoVariance'
   ...
   CHARACTER (LEN=32), PUBLIC :: VarNameG

                                             ! Gravity Wave Drag Parameterization
   REAL (KIND=r8), PUBLIC :: VarMin=0.0_r8   ! Minimum of Height variance in m2 
   REAL (KIND=r8), PUBLIC :: VarMax=1.6E5_r8 ! Maximum of Height variance in m2 
   ...
   INTEGER, PUBLIC :: nfoua=20   ! To Write Intepoloated Topography Variance Data
   INTEGER, PUBLIC :: nfoub=30   ! To Write Intepolated Topography Data
   INTEGER, PUBLIC :: nfouc=40   ! To Write GrADS Topography and Variance Data
   INTEGER, PUBLIC :: nfctl=50   ! To Write Output Data Description
...
SUBROUTINE InitInputParameters ()
   ...
   NAMELIST /InputDim/ Imax, Jmax, Idim, Jdim, &
                       GrADS, Linear, VarName, VarNameG, DirMain
   ...
   WRITE (UNIT=nfprt, FMT='(A)')    '  VarNameG = '//TRIM(VarNameG)
