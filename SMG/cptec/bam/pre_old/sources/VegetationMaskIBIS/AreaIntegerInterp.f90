...
CONTAINS
  ...
  SUBROUTINE DoAreaIntegerInterp (FieldInput, FieldOutput)
    ...
    REAL (KIND=r8) :: work(NumCat,IdimOut,JdimOut), work2(IdimOut,JdimOut), b(5)
    ...
    DO j=1,JdimOut
       InnerLoopB: DO i=1,IdimOut
          ...
          ELSE
             ...
             FieldOutput(i,j)=nxk
             ns=ns+1
             WRITE (UNIT=*, FMT='(3(A,I6))') ' ns = ', ns, ' i = ', i, ' j = ', j
    ...
    WRITE (UNIT=*, FMT='((4(I3,G14.6)))') (n, work(n,iq,jq),n=1,NumCat)
