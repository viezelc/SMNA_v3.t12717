...
MODULE InputParameters
   ...
   CHARACTER (LEN=59), PUBLIC :: VarName='VegetationMaskIBISClima'

   CHARACTER (LEN=16), PUBLIC :: NameLSMSSiB='ModelLandSeaMask'

   CHARACTER (LEN=24), PUBLIC :: VarNameVeg='VegetationMaskIBIS'

   CHARACTER (LEN=12), PUBLIC :: DirPreOut='pre/dataout/'

   CHARACTER (LEN=13), PUBLIC :: DirModelIn='model/datain/'

   CHARACTER (LEN=49) :: NameNML='VegetationMaskIBIS.nml'
   ...
   INTEGER, PARAMETER, PUBLIC :: NumCat=15
