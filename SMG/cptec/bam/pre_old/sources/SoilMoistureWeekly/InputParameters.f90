...
MODULE InputParameters
   ...
   INTEGER, PUBLIC :: Imax, Jmax, Idim, Jdim,kdim
   ...
   CHARACTER (LEN=18), PUBLIC :: VarNameOut='SoilMoistureWeekly'
   ...
   CHARACTER (LEN=22) :: NameNML='SoilMoistureWeekly.nml'
   ...
   INTEGER, PUBLIC :: nfclm=10   ! To Read Climatological Roughness Length Data
   INTEGER, PUBLIC :: nfout=20   ! To Write Intepolated Climatological Roughness Length Data
...
SUBROUTINE InitInputParameters ()
   ...
   NAMELIST /InputDim/ Imax, Jmax, Idim, Jdim,kdim, &
                       GrADS, Linear, VarName,Date, DirMain
