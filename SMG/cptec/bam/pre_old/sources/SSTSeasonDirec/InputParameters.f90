...
MODULE InputParameters
   ...
   INTEGER , PUBLIC        :: YearInitialCondition           !ano da sst persistida 
   INTEGER , PUBLIC        :: MonthInitialCondition          !mes da sst persistida
   INTEGER, PUBLIC         :: nMonthly             =1        ! ! Number of monthly before persistida
   
   INTEGER, PUBLIC         :: FirstYear=1870                 ! Initial Year of the temporal serie ( sst ) 1870 01 16 12
   INTEGER, PUBLIC         :: LastYear =2017                 ! Last  Year of the temporal serie ( sst )    2017 12

   INTEGER, PUBLIC         :: FirstYearClim=1870             ! Initial Year to sst climatology computation  1870 01 16 12
   INTEGER, PUBLIC         :: LastYearClim =2010             ! Last    Year to sst climatology computation     2017 12
   INTEGER, PUBLIC         :: nMonth   =12                   !numero de meses da climatologia
   ...
   CHARACTER (LEN=255), PUBLIC :: VarName='SSTSeasonDirec'
   ...
   CHARACTER (LEN=23) :: NameNML='SSTSeasonDirec.nml'
   ...
   CHARACTER (LEN=10), PUBLIC :: DatePerc
...
SUBROUTINE InitInputParameters ()
   ...
   NAMELIST /InputDim/ Mend, Kmax, Idim, Jdim, &
                       nMonthly ,FirstYear,LastYear ,&
                       FirstYearClim,LastYearClim ,&
   ...
   WRITE (UNIT=nfprt, FMT='(A,I6)')   '     FirstYear = ', FirstYear
   WRITE (UNIT=nfprt, FMT='(A,I6)')   '      LastYear = ', LastYear 
   WRITE (UNIT=nfprt, FMT='(A,I6)')   ' FirstYearClim = ', FirstYearClim
   WRITE (UNIT=nfprt, FMT='(A,I6)')   '  LastYearClim = ', LastYearClim
   ...
   DatePerc=AddDate(DateICn,nMonthly)
