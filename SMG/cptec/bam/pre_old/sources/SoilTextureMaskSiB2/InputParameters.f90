...
MODULE InputParameters
   ...
   CHARACTER (LEN=59), PUBLIC :: VarName='SoilTextureMaskClima'

   CHARACTER (LEN=16), PUBLIC :: NameLSMSSiB='ModelLandSeaMask'

   CHARACTER (LEN=24), PUBLIC :: VarNameVeg='SoilTextureMaskSiB2'

   CHARACTER (LEN=12), PUBLIC :: DirPreOut='pre/dataout/'

   CHARACTER (LEN=13), PUBLIC :: DirModelIn='model/datain/'

   CHARACTER (LEN=49) :: NameNML='SoilTextureMaskSiB2.nml'
   ...
   INTEGER, PARAMETER, PUBLIC :: NumCat=12
   INTEGER, DIMENSION (NumCat), PUBLIC :: VegClass = &
            (/ 1, 1, 1, 1, 1, 1, 2, 2, 3, 2, 3, 4 /)
