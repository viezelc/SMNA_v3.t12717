...
MODULE InputParameters
   ...
   INTEGER, PUBLIC :: Imax, Jmax,Layer, Idim, Jdim
   ...
   CHARACTER (LEN=55), PUBLIC :: VarNameOut='CLimaSoilMoisture'

   CHARACTER (LEN=32), PUBLIC :: VarName

   CHARACTER (LEN=528), PUBLIC :: DirMain

   CHARACTER (LEN=59) :: NameNML='CLimaSoilMoisture.nml'
...
SUBROUTINE InitInputParameters ()
   ...
   NAMELIST /InputDim/ Imax, Jmax, Idim, Jdim, &
                       GrADS, Linear,Layer, VarName, DirMain
   ...
   GrADS=.TRUE.
   Linear=.TRUE.
   VarName='CLimaSoilMoistureClima '
   DirMain='./ '
