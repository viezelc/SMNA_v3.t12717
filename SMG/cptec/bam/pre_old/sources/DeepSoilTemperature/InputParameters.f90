...
MODULE InputParameters
   ...
   CHARACTER (LEN=19), PUBLIC :: VarNameOut='DeepSoilTemperature'

   CHARACTER (LEN=32), PUBLIC :: VarName

   CHARACTER (LEN=528), PUBLIC :: DirMain

   CHARACTER (LEN=23) :: NameNML='DeepSoilTemperature.nml'
   ...
   INTEGER, PUBLIC :: nfclm=10   ! To Read Climatological DeepSoilTemp Data
   INTEGER, PUBLIC :: nfout=20   ! To Write Intepolated Climatological DeepSoilTemp Data
