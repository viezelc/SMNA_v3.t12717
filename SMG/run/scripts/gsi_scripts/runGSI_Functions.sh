...
# 27 Jul 2026 - L. F. Sapucci - Adicionado uma fun��o especifica para os dados do Fluxo do INPE
#
# !REMARKS:
#
...
linkObsNCEP ( ){
   ...
   # local onde est�o os dados prepbufr do NCEP
...
linkObsINPE ( ){
   ...
   #   local onde est�o os dados prepbufr operacionais recebido pelo INPE 
